from tkinter import Tk,Label,Entry,Button,LabelFrame,messagebox,Text,Toplevel,PhotoImage
...
counterp=1
counterm=1
#photo= PhotoImage(file=r"besmelllah\winwhite.png")
vol=1
countervol=10
...
pauseb=Button(root,text="Pause",height=2,width=4,fg="black",relief="raised",border=5,bg="#F1F0E8",command=lambda:pausep())

mute=Button(root,text="Mute",height=2,relief="raised",border=5,activebackground="red",bg="#F1F0E8",command=lambda:mutep())

voldown=Button(root,text="↓",height=2,relief="raised",border=5,activebackground="red",bg="#F1F0E8",command=lambda:volumedown())
volable=Label(root,text="▁▂▃▄▅▆▇",height=2,relief="flat",border=5,activebackground="red",bg="#F1F0E8")
voldarsad=Label(root,text="100%",height=2,relief="flat",border=5,activebackground="red",bg="#F1F0E8")

volup=Button(root,text="↑",height=2,relief="raised",border=5,activebackground="green",bg="#F1F0E8",command=lambda:volumeup())

posbw=Button(root,text="<<",height=2,relief="raised",border=5,activebackground="green",bg="#F1F0E8",command=lambda:bw())
posfw=Button(root,text=">>",height=2,relief="raised",border=5,activebackground="green",bg="#F1F0E8",command=lambda:fw())

stop=Button(root,text="   Stop ⏹️",height=2,relief="raised",border=5,activebackground="red",bg="#F1F0E8",command=lambda:stoop())


def mutep():
  global counterm,vol,countervol
  if temcode==1:
   if counterm%2==1:
     pygame.mixer.music.set_volume(0)
     mute.config(text="Unmute",fg=rang)
     voldarsad.config(text="0%")
     volable.config(text="")
   elif counterm%2==0:
     pygame.mixer.music.set_volume(vol)
     mute.config(text="Mute",fg="black")
     c=countervol*10
     voldarsad.config(text=f"{countervol*10}%")
     if c==100:
      volable.config(text="▁▂▃▄▅▆▇")       
     elif c==90:       
      volable.config(text="▁▂▃▄▅▆")       
   ...
   if counterm%2==1:
     ...
     pygame.mixer.music.set_volume(vol)
     mute.config(text="Mute",fg="white")
     c=countervol*10
     voldarsad.config(text=f"{countervol*10}%")
     if c==100:
      volable.config(text="▁▂▃▄▅▆▇")       
...
def music():
   ...
   if temcode==1:
    sname=komak['text']
    pygame.mixer.music.load(f"besmelllah\{sname}.mp3")
    pygame.mixer.music.play(loops=0)

    komak.config(text="")

    pauseb.grid(row=1,column=1,columnspan=3,sticky="news")
    mute.grid(row=1,column=4,columnspan=3,sticky="news")
    voldown.grid(row=1,column=7,columnspan=3,sticky="news")
    volable.grid(row=1,column=10,columnspan=4,sticky="news")
    voldarsad.grid(row=1,column=14,columnspan=5,sticky="news")
    volup.grid(row=1,column=19,columnspan=3,sticky="news")
    posbw.grid(row=1,column=22,columnspan=3,sticky="news")
    posfw.grid(row=1,column=25,columnspan=3,sticky="news")
    stop.grid(row=1,column=28,columnspan=3,sticky="news")
    ...
    pauseb.grid(row=1,column=1,columnspan=4,sticky="news")
    mute.grid(row=1,column=5,columnspan=4,sticky="news")
    voldown.grid(row=1,column=9,columnspan=4,sticky="news")
    volable.grid(row=1,column=13,columnspan=6,sticky="news")
    voldarsad.grid(row=1,column=18,columnspan=5,sticky="news")
    volup.grid(row=1,column=23,columnspan=4,sticky="news")
    posbw.grid(row=1,column=22,columnspan=3,sticky="news")
    posfw.grid(row=1,column=25,columnspan=3,sticky="news")
    stop.grid(row=1,column=27,columnspan=4,sticky="news")
def fw():
    global sname

    ost = float(pygame.mixer.music.get_pos()/1000)
    nst=ost+5
    pygame.mixer.music.set_pos(nst*1000)
    ost = float(pygame.mixer.music.get_pos()/1000)
    print(ost)
...
def bw():
    ost = float(pygame.mixer.music.get_pos()/1000)
    nst=ost-5
    pygame.mixer.music.set_pos(nst)
    print(ost)
...
def pausep():
  ...
  if temcode==1:
   if counterp%2==1:
     ...
     pauseb.config(text="Resume",fg=rang)
   elif counterp%2==0:
     pygame.mixer.music.unpause()
     pauseb.config(text="Puase",fg="black")
   counterp=counterp+1
  elif temcode==2:
   if counterp%2==1:
     pygame.mixer.music.pause()
     ...
     pygame.mixer.music.unpause()
     pauseb.config(text="Puase",fg="white")
   counterp=counterp+1
...
def escape():
   ...
   def saive():
    ...
    if clrgt=="dark red":
     ...
     fn.config(fg=rang)
    if temcode==2:
           volable.config(bg="grey",fg="white")
           voldarsad.config(bg="grey",fg="white")
           stop.config(bg="grey",fg="white")
           if clrpause==rang:
            pauseb.config(bg="grey")
           else:
            pauseb.config(bg="grey",fg="white")
           if clrmute==rang:
            mute.config(bg="grey")
           else:
            mute.config(bg="grey",fg="white")
           volup.config(bg="grey",fg="white")
           voldown.config(bg="grey",fg="white")
           posfw.config(bg="grey",fg="white")
           posbw.config(bg="grey",fg="white")
           ...
           volable.config(bg="#F1F0E8",fg="black")
           voldarsad.config(bg="#F1F0E8",fg="black")
           stop.config(bg="#F1F0E8",fg="black")
           if clrpause==rang:
            pauseb.config(bg="#F1F0E8")
           else:
            pauseb.config(bg="#F1F0E8",fg="black")
           if clrmute==rang:
            mute.config(bg="#F1F0E8")
           else:
            mute.config(bg="#F1F0E8",fg="black")
           volup.config(bg="#F1F0E8",fg="black")
           voldown.config(bg="#F1F0E8",fg="black")
           posfw.config(bg="#F1F0E8",fg="black")
           posbw.config(bg="#F1F0E8",fg="black")
